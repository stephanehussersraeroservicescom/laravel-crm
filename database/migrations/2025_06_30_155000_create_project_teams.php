...
return new class extends Migration
{
    ...
    {
        // Project subcontractor teams table for main subcontractors
        Schema::create('project_subcontractor_teams', function (Blueprint $table) {
            ...
            $table->enum('role', ['Commercial', 'Project Management', 'Design', 'Certification', 'Manufacturing', 'Subcontractor'])->nullable();
        ...
        // Pivot table for supporting subcontractors
