<x-table-container title="Project Subcontractor Teams">
    ...
    <x-management-panel title="{{ $editing ? 'Edit Project Team' : 'Add New Project Team' }}">
        <x-form-grid formAction="save">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                ...
                <x-form-field label="Main Subcontractor" name="mainSubcontractor" type="select" :options="$subcontractors->pluck('name', 'id')->toArray()" placeholder="Select Main Subcontractor..." required />
                <x-form-field label="Role" name="role" type="select" :options="array_combine($availableRoles, $availableRoles)" placeholder="Select Role..." />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <x-form-field label="Notes" name="notes" type="textarea" rows="3" placeholder="Optional notes about this team..." />
    ...
    <x-management-panel title="Filter Options">
        <x-table-controls :showSearch="false">
            <div class="flex items-center justify-between">
                <span class="text-sm text-gray-600">All project teams</span>
                    ...
                    <tr class="{{ $team->trashed() ? 'bg-red-50' : 'hover:bg-gray-50' }} transition-colors duration-150">
                        <td class="px-3 sm:px-6 py-4">
                            <div class="flex flex-col">
                                <div class="text-sm font-medium text-gray-900">{{ $team->project->name }}</div>
                                @if($team->trashed())
                        ...
                        <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ optional($team->project->airline)->name ?? '—' }}</div>
                        </td>
                        <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-blue-800">{{ $team->mainSubcontractor->name }}</div>
                        </td>
