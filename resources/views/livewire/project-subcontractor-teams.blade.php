<div>
    <div class="py-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Project Subcontractor Teams</h1>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
            <div class="mb-6">
                <h3 class="text-lg font-medium text-gray-900">{{ $editing ? 'Edit Project Team' : 'Add New Project Team' }}</h3>
            </div>
